...
const TaxiOrderSidebar = () => {
  ...
  return (
    <div
      className={cn('w-full h-44 bg-white bg-transparent fixed bottom-0 left-0 z-10 transition-all duration-700 ',
        {'h-96': process === 'order'},
      ...
      <div
        ...
        <Image src='/icons/chevron-down.svg' width={28} height={28} alt='check-card'/>
      </div>
      <Container>
        <TaxiAddressForm/>
        <TaxiTariffs/>
        <TaxiTripPrice/>
        <Button className='m-auto mt-3' theme='secondary' size='md'>Order</Button>
      </Container>
    </div>
  );
};
